    ...
    <div class="w-[90%] m-auto mt-20 mb-5  p-4 rounded">
        ...
        <div class="flex" v-if="user.roles == 'Coordinator'">
            ...
            <div class="relative">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                ...
                @click="showStudentForm" :class="{'bg-gray-300 hover:bg-gray-300 hover:cursor-not-allowed' :disableAddNewStudent}"
                >
      ...
      <div class="rounded shadow p-4 mt-2 bg-white">
        ...
        <div v-else-if="listStudents.length === 0" class="flex flex-col items-center mt-8 mb-3">
          ...
          <div class="rounded p-2 m-auto mt-4 w-full flex justify-center relative" v-if="listStudents.length > 4" >
  ...
  methods: {
    ...
    getAllBatch() {
      axiosHttp.get('/batches').then(res => {
        ...
        if (this.allClass.length !== 0) {
          this.disableAddNewStudent = false;
        }else {
          this.disableAddNewStudent = true;
        }
      });
    },
    getAllClass() {
