  ...
  <div class="main-form w-[40%] ">
    ...
    <form class="shadow p-4 bg-white" @submit.prevent="createNewStudent">
      ...
      <div class="flex justify-end">
        <button type="button" @click="$emit('closeForm')" class="bg-red-500 hover:bg-red-600  text-white p-1.5 px-3  rounded focus:outline-none focus:shadow-outline" :disabled = isCreate>Cancel</button>
        <button type="submit" class="bg-blue-500 hover:bg-blue-600 mx-2 text-white p-1.5 px-3 rounded focus:outline-none focus:shadow-outline" :disabled = isCreate>Add Student</button>
      </div>
    </form>
  </div>
