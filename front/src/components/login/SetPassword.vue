<template>
  <div
    class="w-full m-auto h-[100vh] flex items-center justify-center bg-white"
  >
    <div
      class="flex items-center justify-center py-10 px-5 w-[50%] bg-gray-100 shadow rounded"
    >
      <form class="w-[80%]">
        <h1 class="text-2xl font-semibold text-center p-1 mb-6 text-primary">
          Hi Username
        </h1>
        <div class="mb-2 relative">
          <label class="block text-gray-700 text-md" for="password"></label>
          <input
