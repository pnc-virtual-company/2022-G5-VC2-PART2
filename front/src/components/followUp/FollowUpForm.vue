          ...
          <div class="flex justify-around mt-2">
            <div>
              <div class="flex items-center mb-2">
                <input v-model="type" id="default-checkbox" type="checkbox" value="family" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 ">
                <label class="ml-2">Family</label>
              </div>
              <div class="flex items-center mb-1">
                <input v-model="type" id="default-checkbox" type="checkbox" value="communication" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 ">
                <label class="ml-2">Communication</label>
              </div>
              <div class="flex items-center mb-1">
                <input v-model="type" id="default-checkbox" type="checkbox" value="relationship" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 ">
                <label class="ml-2">Relationship</label>
              </div>
            </div>
            <div>
              <div class="flex items-center mb-1">
                <input v-model="type" id="default-checkbox" type="checkbox" value="attitude" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 ">
                <label class="ml-2">Attitude</label>
              </div>
              <div class="flex items-center mb-1">
                <input v-model="type" id="default-checkbox" type="checkbox" value="study" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 ">
                <label class="ml-2">Study</label>
              </div>
              <div class="flex items-center mb-1">
                <input v-model="type" id="default-checkbox" type="checkbox" value="health" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 ">
