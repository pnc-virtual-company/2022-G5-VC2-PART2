      ...
      <tr class="text-center relative p-2 h-16 hover:bg-slate-200 cursor-pointer group" v-for="person of peopleList"
        ...
        <td class="text-left flex justify-between mt-5">
          ...
          <div class="flex absolute justify-end right-2">
            <svg @click="deletePerson(person.id)" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="w-5 h-5 mr-4 hidden group-hover:block text-red-500 cursor-pointer ease-in-out duration-200" >
