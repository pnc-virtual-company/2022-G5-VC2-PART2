<template>
      ...
      <div class="mt-28 h-auto justify-center w-[70%] m-auto p-2">
        ...
        <div class="bg-gray-100 w-full relative shadow rounded h-auto p-4 px-8">
          <svg
            ...
            @click="editInfo" v-if="user.roles === 'Coordinator'"
          >
            <path
          ...
          <div class="flex justify-center items-center mt-6 mb-6">
            ...
            <div class="w-10/12 h-auto rounded relative bg-white shadow">
              <div
              ...
              >
                ...
                <div class="p-2 ml-4" v-if="!isEdit">
                  ...
                  <div v-if="student!=null">
                    <p class="mt-4">{{ student.class_name }}</p>
                    <p class="mt-4">{{ student.id_student }}</p>
                  </div>
                </div>
  ...
  import ResetPassword from "../views/Admin/login&signout/ResetNewPassword.vue";
  import alert from './widgets/AlertSuccess.vue';
  export default {
    components: {
    ...
    methods: {
      ...
      getInfoAdmin() {
        if (localStorage.getItem('role') === 'TEACHER') {
          ...
          axios
          .get("/users/student/" + localStorage.getItem("userId"))
          .then((res) => {
            this.user = res.data.userData[0];
            this.student = res.data.studentData;
          });
        }
